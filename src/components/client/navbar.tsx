    ...
    <Popover>
      ...
      <PopoverContent align="end" className="w-96 p-0 shadow-xl border-slate-100 rounded-xl overflow-hidden">
        ...
        <div className="p-4 border-b border-slate-100 bg-white flex justify-between items-center">
          <div>
             <h4 className="font-bold text-slate-900">Phòng yêu thích</h4>
             <p className="text-xs text-slate-500 mt-0.5">Bạn đã lưu {items.length} phòng</p>
          </div>
          {items.length > 0 && (
...
export const Navbar = () => {
  ...
  const routes = [
    ...
    { href: "/search", label: "Tìm phòng", active: pathname === "/search" },
    { href: "/compare", label: "So sánh", active: pathname === "/compare" },
