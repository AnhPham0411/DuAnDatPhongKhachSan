    ...
    <div className="space-y-8">
      ...
      <div className="flex gap-4 items-center bg-white p-6 rounded-xl border shadow-sm">
        <div className="flex-1">
          <Input 
            placeholder="Tên tiện nghi (Ví dụ: Wifi, Bể bơi, Gym...)" 
            value={name}
      ...
      <div className="space-y-2">
         <h3 className="font-semibold text-gray-700">Danh sách hiện có ({initialData.length})</h3>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="h-9 w-9 rounded-full bg-slate-100 flex items-center justify-center text-slate-600">
                    {/* Nếu sau này bạn làm thêm icon picker thì hiển thị icon ở đây */}
